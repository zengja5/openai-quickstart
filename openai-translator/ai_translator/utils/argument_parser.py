...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--target_language', type=str, help='The target language that the book need to be translated to.')
        self.parser.add_argument('--pages', type=int, help='page count of the PDF file to translate.')
